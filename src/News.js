...
const News = () => {
  return (
    <div className=''>
        ...
        <h1 className='text-latest text-center font-bold text-[300px] mt-20'>NEWS</h1>
        <div className='container absolute mb-8 top-64 flex gap-x-8 left-10  mx-auto items-center justify-center'>
            <div className='flex flex-col w-[360px]'>
            <img className='w-[360px] h-[420px] object-cover transition-all duration-700 cursor-pointer hover:scale-105' src="https://wp.nkdev.info/redlens/dark/wp-content/uploads/sites/2/2020/09/post-8-768x513.jpg" alt="" />
...
<span className='text-white font-bold text-lg transition cursor-pointer hover:text-redhover'>Read More</span>
            </div>
            <div className='flex flex-col w-[360px]'>
            <img className='w-[360px] h-[420px] object-cover transition-all duration-700 cursor-pointer hover:scale-105' src="https://wp.nkdev.info/redlens/dark/wp-content/uploads/sites/2/2020/09/post-7-1024x479.jpg" alt="" />
            <h6 className='text-gray-500  mb-4 mt-8 font-bold transition cursor-pointer hover:text-white'>FOOD</h6>
...
<span className='text-white font-bold text-lg transition cursor-pointer hover:text-redhover'>Read More</span>
            ...
            <div className='flex flex-col w-[360px]'>
            <img className='w-[360px] h-[420px] object-cover transition-all duration-700 cursor-pointer hover:scale-105' src="https://wp.nkdev.info/redlens/dark/wp-content/uploads/sites/2/2020/09/post-6-1280x735.jpg" alt="" />
            <h6 className='text-gray-500  mb-4 mt-8 font-bold transition cursor-pointer hover:text-white'>FOOD</h6>
